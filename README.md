...
面向人工智能研究者的会议投稿全生命周期追踪平台。项目覆盖 23 个会议，从摘要注册、论文提交一路追踪到 Rebuttal、录用通知、Camera-ready 和会议举办。

## 首版能力

- 7 个 CCF 人工智能 A 类、14 个 CCF 人工智能 B 类，以及精选扩展 ACM MM、WWW
...
仓库包含 23 个会议的基础信息和标准生命周期节点。2026 年 8 月 3 日尚未由官网公布的未来日期均明确标为 `tbd`；界面不会为其生成虚假倒计时。ACM MM 与 WWW 的 `curated_extra` 为 `true`，避免误认为它们属于 CCF 人工智能类别。
