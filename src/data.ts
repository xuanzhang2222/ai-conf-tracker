...
export const eventTypeLabels: Record<string, string> = {
  ...
  artifact_deadline: 'Artifact 截止', registration_open: '参会注册开放', author_registration_deadline: '作者注册截止',
  early_registration_deadline: '早鸟注册截止', standard_registration_deadline: '标准注册截止',
  registration_refund_deadline: '注册退款截止',
